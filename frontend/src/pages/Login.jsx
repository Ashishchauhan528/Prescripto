...
const Login = ()=>{
    ...
    return(
        ...
        <form onSubmit={onSubmitHandler} className='min-h-[80vh] flex items-center'>
            <div className='flex flex-col gap-3 m-auto items-start p-8 min-w-85 sm:min-w-96 border border-zinc-100 rounded-xl text-zinc-600 text-sm shadow-xl'>
...

                {
                    state === 'Sign Up'
                     ...
                     : <p>Create a new account? <span onClick={()=>{setState('Sign Up')}} className='text-primary underline cursor-pointer'>Register</span></p>
                }
            </div>
